...
<head>
 ...
 <link rel="stylesheet"
    ...
    include "../../koneksi.php";
        ...
        $d="Tambah Desa $nama_kecamatan"; 
        $kd="kecamatan/tambah_desa.php?id_kecamatan=$id"; 
        $e=""; 
        $ke=""; 
        $pemisah= " || ";
            ...
            <div class="box box-primary">
              <div class="box-header with-border">
                ...
                <?php
                    ...
                    ?>
                      <form action="tambah_desa_proses.php?id_kecamatan=<?php echo $_GET['id_kecamatan'] ;?>" method="post" role="form">
                        <div class="box-body">
                          ...
                          <div class="form-group">
                            ...
                            <input type="nama_desa" name="nama_desa" class="form-control" placeholder="Nama Kecamatan">
                          </div>
                        </div>
                        <!-- /.box-body -->
                    ...
                    ?>
                  <center><a class="btn btn-primary" data-original-title="" href="detail_kecamatan.php?id_kecamatan=<?php echo $_GET['id_kecamatan'] ;?>"><i class="fa fa-chevron-left"></i>Kembali</a></center>
            </div>
            <!-- Main content -->
            <!-- /.content -->
        </section>
