            ...
            <h5>
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title"><b>Input Data Kecamatan</b></h3>
                </div>
                  <!-- /.box-header -->
                  <!-- form start -->
                  <form action="tambah_proses.php" method="post" role="form">
                    <div class="box-body">
                      <div class="form-group">
                        <label for="exampleInputEmail1">Nama Kecamatan</label>
                        <input type="nama_kecamatan" name="nama_kecamatan" class="form-control" placeholder="Nama Kecamatan">
                      </div>
                    </div>
