...
<head>
 ...
 <link rel="stylesheet"
    ...
    include "../../koneksi.php";
        ...
        $d="Edit Hasil Pertanian Desa $nama_desa"; 
        $kd="desa/edit_hasil_pertanian.php?id_hasil_pertanian=$id"; 
        $e=""; 
        $ke=""; 
        $pemisah= " || ";
            ...
            <div class="box box-primary">
              <div class="box-header with-border">
                ...
                <?php
                    ...
                    ?>
                      <form action="update_hasil_pertanian.php?id_desa=<?php echo $_GET['id_desa'] ;?>" method="post" role="form">
                        <div class="box-body">
                          <div class="form-group">
                          <label exampleInputEmail1>Id Hasil Pertanian</label>
                          <input type="text" name="id_hasil_pertanian" class="form-control" value="<?php echo $d['id_hasil_pertanian']; ?>">
                          </div>
                          <div class="form-group">
                  ...
                  <center><a class="btn btn-primary" data-original-title="" href="detail_desa.php?id_desa=<?php echo $d['id_desa']; ?>"><i class="fa fa-chevron-left"></i>Kembali</a></center>
                  <?php
                    }
                    ?>
            </div>
