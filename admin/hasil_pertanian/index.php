                    ...
                    <div class="box-body">
                      <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tr>
                          ...
                          <th><center><a class="btn btn-sm btn-primary tooltips" data-original-title=""href="tambah_hasil_pertanian.php"><i class="fa fa-plus"></i> Tambah</a></center></th>
                        </tr>
                        </thead>
                        <tbody>
                        <?php
                        ...
                        <tr>
                          ...
                          <a class="btn btn-sm btn-warning tooltips" href="edit_hasil_pertanian.php?id_hasil_pertanian=<?php echo $d['id_hasil_pertanian']; ?>"><i class="fa fa-edit"></i>EDIT</a>
                          <a class="btn btn-sm btn-danger tooltips" href="hapus_hasil_pertanian.php?id_hasil_pertanian=<?php echo $d['id_hasil_pertanian']; ?>"><i class="fa fa-trash"></i>HAPUS</a></center>
                          </td>
                        </tr>
                        <?php
                        }
